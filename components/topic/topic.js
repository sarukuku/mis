...
const Topic = ({topic}) => {
    ...
    return (
        <Card className={classes.topic}>
            <CardHeader className={classes.topicHeader} title={<Typography className={classes.topicTitle} component="h4">{name}</Typography>}/>
            ...
            <CardActions disableSpacing>
                <LabeledInput formClass={classes.addNote} value={newNote} valueSetter={setNewNote}
                              submitHandler={createNote} hint="Add new note"/>
            </CardActions>
        </Card>
    )
}
